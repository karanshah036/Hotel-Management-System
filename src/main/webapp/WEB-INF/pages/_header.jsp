...
<div class="header-container"
	style="overflow: hidden;text-align: left; border-bottom: 1px solid #ccc; position: relative; background: #5f5f5f; color: white;">

	<div class="site-name"
		style="font-size: 200%; margin: 10px 10px 10px 0px; padding: 5px;">Fintels</div>
	...
	<div class="header-bar"
        ...
        Hello
           <a href="${pageContext.request.contextPath}/accountInfo">
				${pageContext.request.userPrincipal.name} // ${sessionScope.user.userName}</a>
         &nbsp;|&nbsp;
